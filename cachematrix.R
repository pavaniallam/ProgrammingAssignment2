...
## CacheSolve function is used to compute the inverse of the matrix returned by 
## makeCaheMatrix. If inverse of the matrix is already calculated then CacheSolve 
## funtion has to retrieve the inverse from cache.
